import { StyleSheet, Text, View, Button, TextInput, SafeAreaView, Image, TouchableOpacity, Alert } from 'react-native';
        ...
        <View style={styles.form}>
          ...
          <View style={styles.input}>
            ...
            <TouchableOpacity style={{ marginTop: "auto" }} onPress={() => {
              ...
              <Text style={{ textDecorationLine: 'underline', color: '#3349FF' }}>Forgot password</Text>
            </TouchableOpacity>
          </View>
          <View style={styles.formAction}>
            ...
            <TouchableOpacity style={{ marginTop: "auto" }} onPress={() => navigation.navigate('RegisterScreen')}>
              <Text style={styles.formFooter}>Don't have account? <Text style={{ textDecorationLine: 'underline' }}>Sign up</Text></Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
