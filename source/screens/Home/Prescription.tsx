...
const Prescription = ({ route, navigation }: any) => {
    ...
    return (
        <>
            <CustomAppbar title={'Xác nhận đơn thuốc'} goBack={() => navigation.goBack()} />
            <ScrollView style={styles.container}>
                ...
                <View style={{ height: 1, backgroundColor: theme.colors.onSurface, marginBottom: 10, marginTop: 10 }} />
                <SafeAreaView>
                        ...
                        <View>
                            ...
                            <View style={{ flexDirection: 'row', paddingHorizontal: 10 }}>
                                <View style={{ width: '24%', marginRight: '1%' }}>
                                    <Text style={styles.label}>Sáng: {item.schedule.morning}</Text>
                                </View>
                                <View style={{ width: '24%', marginRight: '1%' }}>
                                    <Text style={styles.label}>Trưa: {item.schedule.afternoon}</Text>
                                </View>
                                <View style={{ width: '24%', marginRight: '1%' }}>
                                    <Text style={styles.label}>Chiều: {item.schedule.evening}</Text>
                                </View>
                                <View style={{ width: '24%' }}>
